...
<div class="onlyContent">
    ...
    <div id = "highchartsContent" style="padding:0vh 1vw 0vh 1vw; width:100%; height:2000px">
        <!--        <iframe class = "highchartsFrame"  id="graphContent" scrolling ="no" src="/./CrimeEmergencyServices/stats" name="iframe_indicators">
...
<script type="text/javascript">
    ...
    function myFunction() {
//        document.getElementById("highchartsContent").innerHTML = ;
