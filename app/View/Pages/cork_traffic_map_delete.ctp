...
<div class="onlyContent">
    ...
    <p>Click on the map to explore live information on the environment, 
        including water levels and air quality. Details on data sources are 
        provided below. </p>
    ...
    <div id="dataSources" class="homeBlock" style="width:100%; text-align:justify">
        <h2>Data Sources</h2>
