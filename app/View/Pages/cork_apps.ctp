...
<div class="onlyContent">
    ...
    <div style="float:left; padding: 2vh 0vw 1vh 0vw; border-bottom:2px solid #e5e5e5">
        <div class="col-3" style=" padding: 2vh 2vw 1vh 2vw;" id="corkPark" align="center">
            ...
            <a href="https://appsto.re/ie/wVuOab.i"  target="_blank">
                <img height="25vmin" src="/img/Dashboard/icons/App_Store_Badge.svg">
            </a>
            <h2>Park by Phone</h2>
        </div>
        <div class="col-3" style=" padding: 2vh 2vw 1vh 2vw" id="journeyPlan" align="center">
        ...
        <div class="col-3" style=" padding: 2vh 2vw 1vh 2vw" id="irishRail" align="center">
        ...
        <div class="col-3" style=" padding: 2vh 2vw 1vh 2vw" id="corkAirport" align="center">
    ...
    <div style="float:left; border-bottom:2px solid #e5e5e5">
        <div class="col-3" style=" padding: 2vh 2vw 1vh 2vw" id="cyclePlanner" align="center">
        ...
        <div class="col-3" style=" padding: 2vh 2vw 1vh 2vw" id="corkbikes" align="center"> 
        ...
        <div class="col-3" style=" padding: 2vh 2vw 1vh 2vw"  id="corktaxi" align="center"> 
        ...
        <div id="corkmaps" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
    ...
    <div style="float:left; border-bottom:2px solid #e5e5e5">
        <div id="corkcitynow" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="corkpocketguide" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="corkcity" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="corkcityguide" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
    ...
    <div style="float:left; border-bottom:2px solid #e5e5e5">
        <div id="westcorkguide" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="explorewestcork" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="spikeisland" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="discovercork" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
    ...
    <div style="float:left; border-bottom:2px solid #e5e5e5">
        <div id="youghal" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="corktides" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="corkarts" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="corkoperahouse" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
    ...
    <div style="float:left; border-bottom:2px solid #e5e5e5">
        <div id="CorkCountyLibraries" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="CorkPlanning" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="CorkCityLibraries" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="mapAlerterText" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
    ...
    <div style="float:left; border-bottom:2px solid #e5e5e5">
        <div id="fixYourSteetText" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="Corkuniversityhospital" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="UCC" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
        ...
        <div id="cit" class="col-3" style=" padding: 2vh 2vw 1vh 2vw" align="center"> 
