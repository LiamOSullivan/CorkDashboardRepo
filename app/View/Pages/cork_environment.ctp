...
<div class="onlyContent">
    ...
    <div id="dataSources" class="homeBlock" style="width:90%; text-align:justify"></div>
</div>
...
<script>
    ...
    divData.innerHTML = divData.innerHTML + "<h2>Data Sources</h2>";
    divData.innerHTML = divData.innerHTML + "<p>The Air Quality Index is taken directly from the Environmental Protection Agency (EPA). More information about how this index is compiled can be found <a href=\"http://www.epa.ie/air/quality/index/#.U_tMLPldXh4\" target=\"_blank\">here.</a></p>";
    divData.innerHTML = divData.innerHTML + "<p>The Air Quality Data at selected sites is taken from the Environmental Protection Agency (EPA). More information about this data can be found <a href=\"http://www.epa.ie/air/quality/data/#.U_tPn_ldXh7\" target=\"_blank\">here.</a></p>";
    divData.innerHTML = divData.innerHTML + "<p>The Hydrometric Data (water level) at selected sites is taken from the Environmental Protection Agency (EPA). More information about this data can be found <a href=\"http://www.epa.ie/hydronet/#Water%20Levels\" target=\"_blank\">here.</a></p>";
    divData.innerHTML = divData.innerHTML + "<p>The River Level Data at selected sites is taken from the Office of Public Works (OPW). More information about this data can be found <a href=\"http://waterlevel.ie/\" target=\"_blank\">here.</a></p>";
    divData.innerHTML = divData.innerHTML + "<p>Selected Weather Data is taken from Transport Infrastructure Ireland. More information about this data can be found <a href=\"https://www.nratraffic.ie/weather/\" target=\"_blank\">here</a>.</p>";
