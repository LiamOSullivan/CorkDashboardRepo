...
<?php $this->assign('title', "Travel Map"); ?>
...
*/
labels.push('');
labels.push('<i style="background: url(\'/img/Dashboard/trafficCam.png\'); background-size: 18px 18px;"></i> ' + ' Traffic Camera');
...
//map.addLayer(carparks);

layerControl = L.control.layers(baseMaps, overlayMaps, { collapsed: true });
