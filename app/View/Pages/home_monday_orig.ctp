...
<html>
    <head>
        <!--<title>Cork Dashboard Home</title>   this is ignored for title in Layouts>default --> 
        ...
        <script src="../Dashboard/js/dashboard_init.js" type="text/javascript"></script>
...
//    Commmenting out until adding cams back                                                            document.getElementById("cam163").innerHTML = "<img src=" + imgurl163 + " alt=\"cam\" style=\"width:100%\">"
