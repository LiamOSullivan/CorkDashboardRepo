...
<html>
<head>
  <title>Dublin Dashboard Environment</title>
  <meta charset="utf-8" />
        ...
        //EPAOverall Air Quality
         $.get("/CarParks/airQuality", function(point){
           ...
           for(var i=0;i<count;i++){
             ...
             divData.innerHTML = divData.innerHTML +"<h5>The Ambiet Sound Data is taken from Dublin City Council's Ambient Sound Monitoring Network. More information about how to interpret the sound levels can be found <a href=\"http://www.epa.ie/air/quality/index/#.U_tMLPldXh4\" target=\"_blank\">here.</a></h5>";
             ...
             divData.innerHTML = divData.innerHTML +"<h5>The Hydrometric Data (water level) at selected sites is taken from the Environmental Protection Agency (EPA). More information about this data can be found <a href=\"http://hydronet.epa.ie/introduction.htm\" target=\"_blank\">here.</a></h5>";
...
//hydro levels
             ...
             $.get("/CarParks/hydroLevels", function(point){
                obj = JSON.parse(point);
                  for(i = 0; i< 30; i=i+7){  
               var text = "<table style=\"width:300px\"><tr><td><p class=\"intab\"> Water Level at "+obj[i]+"  </p> "+obj[i+3]+":  " +obj[i+4]+"m <br>"+obj[i+5] +": "+obj[i+6] +"m                          </td></tr></table>"
...
//sound sites
  ...
  $.get("/CarParks/ambientSound1", function(point){
                ...
                var siteId = "Site1";
                var text = "<table style=\"width:300px\"><tr><td><p class=\"intab\"> Sound Level at "+getSoundSiteName(siteId).name+"</p> "+currentDate+" "+currentTime+": " +value+"db<br>"+previousDate+" "+previousTime+": " +previousValue+"db </td></tr></table>"
