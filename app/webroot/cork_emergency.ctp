    ...
    <body>
        <!--Responsive content-->
                <div style="border-bottom:2px solid #e5e5e5">
                    <h2>Crime and Emergency Services Indicators</h2>
                 
                </div>
                <div>
                    <p>Explore information relating to crime rates in Cork, fire 
                brigade activities and injuries and fatalities on Cork roads.</p>
                </div>
                    <?php echo $this->fetch('content') ?>
